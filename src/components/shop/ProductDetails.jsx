...
export default function ProductDetails() {
    ...
    return (
        <div className={`${""}  absolute top-0 md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4`}>
            <div className="xl:w-2/6 lg:w-2/5 w-80 md:block hidden">
                <Image height={700} width={500} objectFit="cover" objectPosition="center" layout="responsive" className="w-full" alt="image of a girl posing" src="https://i.ibb.co/QMdWfzX/component-image-one.png" />
                <Image height={700} width={500} objectFit="cover" objectPosition="center" layout="responsive" className="mt-6 w-full" alt="image of a girl posing" src="https://i.ibb.co/qxkRXSq/component-image-two.png" />
            </div>
            <div className="md:hidden">
                <Image height={700} width={500} objectFit="cover" objectPosition="center" layout="responsive" className="w-full" alt="image of a girl posing" src="https://i.ibb.co/QMdWfzX/component-image-one.png" />
                <div className="flex items-center justify-between mt-3 space-x-4 md:space-x-0">
                    <Image height={700} width={500} objectFit="cover" objectPosition="center" layout="responsive" alt="image-tag-one" className="md:w-48 md:h-48 w-full" src="https://i.ibb.co/cYDrVGh/Rectangle-245.png" />
                    <Image height={700} width={500} objectFit="cover" objectPosition="center" layout="responsive" alt="image-tag-one" className="md:w-48 md:h-48 w-full" src="https://i.ibb.co/f17NXrW/Rectangle-244.png" />
                    <Image height={700} width={500} objectFit="cover" objectPosition="center" layout="responsive" alt="image-tag-one" className="md:w-48 md:h-48 w-full" src="https://i.ibb.co/cYDrVGh/Rectangle-245.png" />
                    <Image height={700} width={500} objectFit="cover" objectPosition="center" layout="responsive" alt="image-tag-one" className="md:w-48 md:h-48 w-full" src="https://i.ibb.co/f17NXrW/Rectangle-244.png" />
                </div>
            </div>
                ...
                <div>
                    <div className="border-t border-b py-4 mt-7 border-gray-200">
                        <div data-menu className="flex justify-between items-center cursor-pointer">
                            ...
                            <button onClick={handleClick} className="cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-400 rounded" role="button" aria-label="show or hide">
                                <svg className={` ${isRotated ? 'rotate-180' : ''} transform text-gray-300 dark:text-white`} width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M9 1L5 5L1 1" stroke="currentColor" stroke-width="1.25" stroke-linecap="round" stroke-linejoin="round" />
                                </svg>
                            </button>
                        </div>
                        <div className={`${isHidden ? 'hidden' : ''} pt-4 text-base leading-normal pr-12 mt-4 text-gray-600 dark:text-gray-300`}id="sect">You will be responsible for paying for your own shipping costs for returning your item. Shipping costs are nonrefundable</div>
                    </div>
                </div>
                <div>
                    <div className="border-b py-4 border-gray-200">
                        ...
                        <div className={`${isHidden ? 'hidden' : ''} pt-4 text-base leading-normal pr-12 mt-4 text-gray-600 dark:text-gray-300`} id="sect">If you have any questions on how to return your item to us, contact us.</div>
                    </div>
                </div>
            </div>
        </div>
