            ...
            <div className=' bg-green-200 bg-opacity-10 rounded-2xl shadow-md p-8'>
                <div className="py-6">
                    <div className="flex bg-green-400 rounded-lg shadow-lg overflow-hidden mx-auto max-w-sm lg:max-w-4xl">
                        <div className="hidden lg:block lg:w-1/2 bg-cover" style={{ backgroundImage: `url('/images/need-something.jpg')` }}></div>
                        <div className="w-full p-8 lg:w-1/2">
                            {/* <h2 className="text-2xl font-semibold text-gray-700 text-center">Brand</h2> */}
                            <p className="text-4xl text-gray-600 text-center">Welcome back!</p>
                            ...
                            <div className="mt-4 flex items-center justify-between">
                                ...
                                <Link href="/profile/register" className="text-xs text-gray-500 uppercase">or sign up</Link>
                                <span className="border-b w-1/5 md:w-1/4"></span>
                            </div>
                        </div>
                    </div>
